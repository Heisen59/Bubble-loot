...
-- Populate `BubbleLoot_G.playerInfo`.
...
--
---@return PlayerInfo
function BubbleLoot_G.playerInfo.New(class, classFilename, subgroup, groupTypeUnit)
    return {
        class = class,
...
---@return PlayerInfo
function BubbleLoot_G.playerInfo.Get(self, name, groupType)
